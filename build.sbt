...
lazy val rootNativeLink =
    taskKey[File]("Build the Scala Native binary and copy it to the repository root")
...
lazy val web = (project in file("web"))
    .enablePlugins(
      ...
      org.scalablytyped.converter.plugin.ScalablyTypedConverterExternalNpmPlugin
    )
    .settings(
      resolvers ++= commonResolvers,
      name := "ndpc-web",
      ...
      Compile / scalaJSLinkerConfig ~= {
          _.withSourceMap(false)
              ...
              .withModuleSplitStyle(
                ModuleSplitStyle.SmallModulesFor(List("ndpc.web", "ndpc.frontend", "parsley", "scala"))
              )
      },
