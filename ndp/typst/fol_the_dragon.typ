...
#start(pf(
  ($forall x. (forall y. "child"(y, x) -> "fly"(y)) and "dragon"(x) -> "happy"(x)$, premise),
  ($forall x. "green"(x) and "dragon"(x) -> "fly"(x)$, premise),
  ($forall x. (exists y. "parent"(y, x) and "green"(y)) -> "green"(x)$, premise),
  ($forall z. forall x. "child"(x, z) and "dragon"(z) -> "dragon"(x)$, premise),
